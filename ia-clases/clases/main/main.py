...
def main():
    ...
    try:
        ...
        if explain_slides_with_random_questions(engine, pdf_path, pdf_text, current_users,
            ...
            sequence_mapping = {
                1: "Inicio",    # Después de la diapositiva 1
                3: "Test2",         # Después de la diapositiva 3
                5: "Tomar",      # Después de la diapositiva 5
                7: "Awiwi",          # Después de la diapositiva 7
                9: "Tomar"          # Después de la diapositiva 9
            }

...
class SequenceBuilderTab(BaseTab):
    ...
    def create_slider_controls(self):
        ...
        try:
            ...
            if not hasattr(self, 'left_brazo_var'):
                self.left_brazo_var = tk.IntVar(value=10)
                self.left_frente_var = tk.IntVar(value=80)
                self.left_high_var = tk.IntVar(value=80)
                self.right_brazo_var = tk.IntVar(value=40)
            ...
            left_brazo_scale = tk.Scale(left_arm_frame, from_=0, to=90, orient="horizontal",
            ...
            tk.Label(left_arm_frame, text="Frente:", bg='#4d4d4d', fg='#ffffff',
                    font=('Arial', 9)).pack(anchor="w")
            ...
            tk.Label(left_arm_frame, text="High:", bg='#4d4d4d', fg='#ffffff',
                    font=('Arial', 9)).pack(anchor="w")
            ...
            tk.Label(right_arm_frame, text="Brazo:", bg='#4d4d4d', fg='#ffffff',
                    font=('Arial', 9)).pack(anchor="w")
            right_brazo_scale = tk.Scale(right_arm_frame, from_=0, to=90, orient="horizontal",
            ...
            tk.Label(right_arm_frame, text="Frente:", bg='#4d4d4d', fg='#ffffff',
                    font=('Arial', 9)).pack(anchor="w")
            ...
            tk.Label(right_arm_frame, text="High:", bg='#4d4d4d', fg='#ffffff',
                    font=('Arial', 9)).pack(anchor="w")
            ...
            tk.Label(right_arm_frame, text="Pollo:", bg='#4d4d4d', fg='#ffffff',
                    font=('Arial', 9)).pack(anchor="w")
            right_pollo_scale = tk.Scale(right_arm_frame, from_=0, to=90, orient="horizontal",
    ...
    def create_arrow_controls(self):
        ...
        # Left arm arrows
            ...
            self.create_arm_arrow_control(left_arm_frame, "Brazo", self.left_brazo_var, 0, 90, 'left_brazo')
            self.create_arm_arrow_control(left_arm_frame, "Frente", self.left_frente_var, 0, 180, 'left_frente')
            self.create_arm_arrow_control(left_arm_frame, "High", self.left_high_var, 0, 180, 'left_high')
            ...
            self.create_arm_arrow_control(right_arm_frame, "Brazo", self.right_brazo_var, 0, 90, 'right_brazo')
    ...
    def create_arm_arrow_control(self, parent, label, variable, min_val, max_val, arm_type):
        ...
        step = 5 if arm_type in ['left_brazo', 'right_brazo', 'left_high', 'right_high', 'right_pollo'] else 10
        ...
        try:
            if self.esp32_connected and self.esp32_client and not self.debug_mode:
                    ...
                    if response.status_code == 200:
                        ...
                        self.esp32_client.send_movement(10, 40, 80, 90, 80, 80, 45)

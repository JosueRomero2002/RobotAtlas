...
class SimulatorTab(BaseTab):
    ...
    def setup_tab_content(self):
        ...
        for servo in ['brazo_izq', 'frente_izq', 'high_izq']:
    ...
    def update_arms_position(self):
        ...
        try:
            ...
            self.robot_arms_state['left_arm']['brazo_izq'] = 10 + 5 * math.sin(current_time * 0.5)
            self.robot_arms_state['left_arm']['frente_izq'] = 80 + 10 * math.sin(current_time * 0.3)
            self.robot_arms_state['left_arm']['high_izq'] = 80 + 5 * math.cos(current_time * 0.4)
            
            # Update right arm positions
            self.robot_arms_state['right_arm']['brazo_der'] = 40 + 8 * math.sin(current_time * 0.6)
            self.robot_arms_state['right_arm']['frente_der'] = 90 + 12 * math.sin(current_time * 0.2)
            self.robot_arms_state['right_arm']['high_der'] = 80 + 6 * math.cos(current_time * 0.5)
            self.robot_arms_state['right_arm']['pollo_der'] = 45 + 3 * math.sin(current_time * 0.7)

...
1. En la sección **"Información de Red"** verás:
   - **IP Local**: Tu IP (ej: `192.168.100.6`)
...
#### **Ejemplo de Logs**
```
[14:30:15] IP copiada al portapapeles: 192.168.100.6
[14:30:20] Información de red actualizada - IP: 192.168.100.6

...
```
1. Presiona "📝 Poner Ejemplo" → Se establece 192.168.100.6:8080
...
```
• "🚀 IP Desarrollo" → 192.168.100.6:8080 (inmediato)
...
2. Sistema establece inmediatamente 192.168.100.6:8080
...
```
1. Usuario presiona "📝 Poner Ejemplo" → 192.168.100.6:8080
2. Usuario modifica manualmente a "192.168.100.6:8081"
3. Usuario presiona "⚡ Actualizar IP Inmediatamente"
4. Sistema captura "192.168.100.6:8081" del DOM y aplica
```
